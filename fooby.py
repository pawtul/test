# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 22:19:17 2021
...
class Fooby():
    ...
    def __init__(self, url_path):
        ...
        for script in self.soup.find_all('script'):
            ...
            if re.search(r'var\s+recipeJSON\s+=\s+(.*);', script) != None:
    ...
    def ingredients(self):
        try:
            ingredients = self.soup.find_all('div', {'class': 'recipe-ingredientlist__ingredient-wrapper'})
        except:
            ingredients = []
    ...
    def instructions(self):
        try:
            instructions = self.soup.find('div', {'class': 'col-xs-12 col-sm-12 col-md-12 h-horizontal-guttered'}).text.strip().replace('  ',' ')
        except:
            instructions = ''
        return instructions
    ...
    # def tags(self):
    #     try:
    #         tags = self.soup.find('div', {'class': 'ds-box recipe-tags'}).text
    #         tags = tags.split()
    #     except:
    #         tags = []
    #     return tags
